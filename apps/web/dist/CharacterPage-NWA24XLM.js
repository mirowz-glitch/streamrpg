...
function EldrinGuide() {
  const [step, setStep] = (0, import_react4.useState)(getEldrinStep);
...
function FirstItemCard() {
  const [firstItem, setFirstItem] = (0, import_react5.useState)(null);
  const [dismissed, setDismissed] = (0, import_react5.useState)(() => isFlagSet("first_item_announced"));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "card first-item-card", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "hint", children: '\u{1F9D9} Eldrin: "Nada mal. Agora pelo menos voc\xEA consegue machucar um p\xE3o."' }),
...
function FirstLevelBanner({ level }) {
  const [dismissed, setDismissed] = (0, import_react6.useState)(() => isFlagSet("first_level_announced"));
...
function FirstBossBanner({ channel }) {
  ...
  const [dismissed, setDismissed] = (0, import_react7.useState)(() => isFlagSet("first_boss_seen"));
...
function NewTitleModal({ identity, onEquipTitle }) {
  const [dismissed, setDismissed] = (0, import_react8.useState)(() => isFlagSet("first_title_announced"));
