...
var BossCard = (0, import_react2.memo)(function BossCard2({ channel, compact = false, myCharacterId }) {
  ...
  if (resolved) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `boss-card boss-card-resolved${outcomeClass}${compact ? " boss-card-compact" : ""}`, children: [
      ...
      !compact && state.rewards && state.rewards.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "boss-rewards-list", children: state.rewards.map((r) => {
        const isMine = myCharacterId !== void 0 && r.character_id === myCharacterId;
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: isMine ? "boss-reward-mine" : void 0, children: [
          isMine ? "\u27A4 Voc\xEA" : r.display_name,
          ": +",
          r.xp_granted,
          " XP",
