...
export const NPCS = {
  ...
  taverneira: {
    ...
    quote: "Aqui, toda história vale uma bebida.",
    description: "Serve cerveja e memória em partes iguais — poucos segredos do Reino escapam do balcão dela.",
    icon: "🍺",
    color: "#c9822a",
    shape: "arch",
  },
  viajante: {
    ...
    profession: "Guardião da Casa dos Viajantes",
    quote: "Não sei se é verdade. Mas ouvi de alguém que jura que sim.",
    description: "Já andou por quase todas as regiões do Reino — e voltou com mais perguntas do que respostas.",
    icon: "🧳",
    color: "#e07a5f",
    shape: "shield",
  },
